...
This dashboard covers the course materials for the Ghana Statistical Service course to be held in Accra, December 6-9, 2021.

---

Instructors: 

 - Karen Risør Bjerre (krb@dst.dk)
...
|:------------|:------------------------------------------------|
| *Monday*    |                                                 |
| Afternoon   | Introduction to R and RStudio (PSL)             |
| *Tuesday*   |                                                 |
| Morning     | Data manipulation (MIM)                         |
| Afternoon   | Joins and summarizing data (KRB)                |
| *Tuesday*   |                                                 |
| Morning     | Quality and clean data (PSL)                    |
| Afternoon   | Visualization (MIM)                             |
| *Tuesday*   |                                                 |
| Morning     | Rmarkdown (MIM)                                 |
| Afternoon   | Loops and functions (KRB)                       |
| *Friday*    |                                                 |
| Morning     | Evaluation, agreement on summary mission report |
