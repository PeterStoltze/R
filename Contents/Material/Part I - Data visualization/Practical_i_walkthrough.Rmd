...
The legend is being bothersome here, though. The `ggplot` default is prettier, but also, we could move the legend inside the plot and use a more colorblind-friendly color scale:
```{r}
